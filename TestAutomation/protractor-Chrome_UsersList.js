...
exports.config = {
    ...
    'commonCapabilities': {
      //  'build': ' #169| Run: Chrome| Test: "User List"| Date: ' + new Date().toString(),
        'build':''+protractorConfig.config.BuildTestNumber+'__________________ Run : Chrome_______________ Test : User List______________ ' + dateFormat(new Date(), "mmmm dS, yyyy, h:MM TT"),
        'project': 'Black Book',
        'name': 'User List',
