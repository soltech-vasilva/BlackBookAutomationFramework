...
exports.config = {
    ...
    'commonCapabilities': {
         //Label
        'build':''+protractorConfig.config.BuildTestNumber+'__________________ Run : Chrome_______________ Test : Setup_________________ ' + dateFormat(new Date(), "mmmm dS, yyyy, h:MM TT"),
        'project': 'Black Book',
         'name': 'Setup',
