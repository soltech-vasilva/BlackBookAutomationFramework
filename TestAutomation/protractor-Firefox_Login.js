...
exports.config = {
    ...
    'commonCapabilities': {
       // 'build': ' #169 | Run: Firefox| Test: "Login" | Date: ' + new Date().toString(),
        'build':''+protractorConfig.config.BuildTestNumber+'__________________ Run : Firefox________________ Test : Login_________________ ' + dateFormat(new Date(), "mmmm dS, yyyy, h:MM TT"),
        'project': 'Black Book',
        'name': 'Login',
