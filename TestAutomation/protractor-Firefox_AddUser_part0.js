...
exports.config = {
    ...
    'commonCapabilities': {
         //Label
        'build':''+protractorConfig.config.BuildTestNumber+'__________________ Run : Firefox________________ Test : Add User Part0_________ ' + dateFormat(new Date(), "mmmm dS, yyyy, h:MM TT"),
        'project': 'Black Book',
         'name': 'Add User Part0',
