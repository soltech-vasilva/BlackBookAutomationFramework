...
var BB_UserProfileEditRepo = function BB_UserProfileEditRepo () {
    ...
    BB_UserProfileEditRepo.prototype.Select_Element_NewPassword = element(by.css('input[placeholder="New Password"]'));
    ...
    BB_UserProfileEditRepo.prototype.Select_Element_PreviousPassword = element(by.css('input[placeholder="Previous Password"]'));
    ...
    BB_UserProfileEditRepo.prototype.Select_xpath_ERRORMESSAGE_NewPassword =  by.xpath('//*[@id="page-box"]/user-profile/div/div/div[1]/div[2]/div[1]/div[7]/div[2]/div/error-msg/span');
    BB_UserProfileEditRepo.prototype.Select_xpath_ERRORMESSAGE_ConfirmNewPassword = by.xpath('//*[@id="page-box"]/user-profile/div/div/div[1]/div[2]/div[1]/div[7]/div[3]/div/error-msg/span');
    BB_UserProfileEditRepo.prototype.Select_xpath_ERRORMESSAGE_PreviousPassword = by.xpath('  ');
    ...
    BB_UserProfileEditRepo.prototype.Select_Element_ERRORMESSAGE_PreviousPassword = element( this.Select_xpath_ERRORMESSAGE_PreviousPassword);
};
