...
#Email is Empty Field
  ...
  @TestCases_C-5
  Scenario Outline: "@TestCases_C-5" Enter empty Previous PassWord data will throw error "Required"
    And I click Reset Button
    When I enter my first name <firstName>
    And I enter my last name <lastName>
    And I enter my email address <emailAddress>
...
#####      |    AfirstName | AlastName | AemailAddress@email.com   | (123)456-7890 | QaAdmin123    |                      |
  ...
  @TestCases_C-6
  Scenario Outline: "@TestCases_C-6" Enter empty Strings (SPACE BAR) User Profile data will throw error "Spaces are invalid characters"
    And I click Reset Button
    When I enter my first name <firstName>
