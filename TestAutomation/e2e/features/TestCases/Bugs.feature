...
#
#  @TestCases_A-21
#  Scenario: "@TestCases_A-21" (BB-441) Permissions gets reset after adding "Role's Users"  (re-Open)
...
#
#  @TestCases_A-27
#  Scenario: "@TestCases_A-27" (BB-460) Close "User Edit" wont go back from where it came from.
#    And I click on Admin Tab
#    And I click on Users submenu from Admin Tab
#    And I wait
...
#
#  @TestCases_A-30
#  Scenario: "@TestCases_A-30" (BB-472) Creating new Role will not add User to it.
#    And I click on Admin Tab
#    And I click on Roles submenu from Admin Tab
#    And I click on New Role Button in Role List
...
#  #todo mover esto a visual testing
#  @TestCases_A-38
