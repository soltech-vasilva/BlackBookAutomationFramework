...
var BB_EditRoles = function BB_EditRoles() {
    ...
    BB_EditRoles.prototype.Click_ModalWarningMessage_ConfirmOrCancel_Button = function (buttonName) {
        return new Promise((success, failure) => {
    ...
    BB_EditRoles.prototype.Click_CircleIconInPermissions = function () {
        return new Promise((success, failure) => {
            page.clickButton(BB_editRolesRepo.Select_Element_CircleIconPermission.get(0), protractorConfig.config.WaitTime, success);
        });
    };

    BB_EditRoles.prototype.Verify_ConfirmRoleDeletionMessage_popup = function (errorMessage) {
        return new Promise((success, failure) => {
    ...
    BB_EditRoles.prototype.Verify_FilterByGroupPermissionsName = function (PermissionsName) {
        return new Promise((success, failure) => {
    ...
    BB_EditRoles.prototype.Click_FilterByStatusName = function (FilterByStatusName) {
        return new Promise((success, failure) => {
            page.selectDropdownItemByValue(BB_editRolesRepo.Select_Element_FilterByStatusDropdown, FilterByStatusName, success);
        });
    };

    BB_EditRoles.prototype.Click_FilterByGroupPermissionsName = function (PermissionsName) {
        return new Promise((success, failure) => {
            page.selectDropdownItemByValue(BB_editRolesRepo.Select_Element_FilterByGroupDropdown, PermissionsName, success);
        });
    };

    BB_EditRoles.prototype.Click_RoleMarketSelection = function (roleMarketSelection) {
        return new Promise((success, failure) => {
    ...
    BB_EditRoles.prototype.VerifyButtonsEnableOrDisable = function (ButtonName, isEnableOrDisable) {
        return new Promise((success, failure) => {
            switch (ButtonName.toString().toLowerCase()) {
                case "save":
