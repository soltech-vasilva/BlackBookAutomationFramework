...
exports.config = {
    ...
    'commonCapabilities': {
       // 'build': ' #169 | Run: IE| Test: "Login" | Date: ' + new Date().toString(),
        'build':''+protractorConfig.config.BuildTestNumber+'__________________ Run : IE____________________ Test : Edit Roles____________ ' + dateFormat(new Date(), "mmmm dS, yyyy, h:MM TT"),
        'project': 'Black Book',
        'name': 'Edit Roles',
