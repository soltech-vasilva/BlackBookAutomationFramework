...
exports.config = {
    ...
    'commonCapabilities': {
         //Label
        'build':''+protractorConfig.BuildTestNumber+'__________________ Run : Chrome_______________ Test : Add User Part0_________ ' + dateFormat(new Date(), "mmmm dS, yyyy, h:MM TT"),
        'project': 'Black Book',
         'name': 'Add User Part0',
