...
exports.config = {
    ...
    'commonCapabilities': {
         //Label
        'build':''+protractorConfig.config.BuildTestNumber+'__________________ Run : EDGE_________________ Test : Setup_________________ ' + dateFormat(new Date(), "mmmm dS, yyyy, h:MM TT"),
        'project': 'Black Book',
         'name': 'Setup',
