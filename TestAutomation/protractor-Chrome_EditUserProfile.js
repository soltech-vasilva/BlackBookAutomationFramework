...
exports.config = {
    ...
    'commonCapabilities': {
         //Label
      //  'build': ' #169 |Run: Chrome| Test: "Edit User Profile"| Date: ' + new Date().toString(),
        'build':''+protractorConfig.config.BuildTestNumber+'__________________ Run : Chrome_______________ Test : Edit User Profile_________ ' + dateFormat(new Date(), "mmmm dS, yyyy, h:MM TT"),
        'project': 'Black Book',
